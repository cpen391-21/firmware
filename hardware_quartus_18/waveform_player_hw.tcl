...
add_fileset_file doublesync.v VERILOG PATH doublesync.v


# 
# parameters
# 
add_parameter WAITING STD_LOGIC_VECTOR 0
set_parameter_property WAITING DEFAULT_VALUE 0
set_parameter_property WAITING DISPLAY_NAME WAITING
set_parameter_property WAITING WIDTH 4
set_parameter_property WAITING TYPE STD_LOGIC_VECTOR
set_parameter_property WAITING UNITS None
set_parameter_property WAITING ALLOWED_RANGES 0:15
set_parameter_property WAITING HDL_PARAMETER true
add_parameter WRITE_AUDIO STD_LOGIC_VECTOR 1
set_parameter_property WRITE_AUDIO DEFAULT_VALUE 1
set_parameter_property WRITE_AUDIO DISPLAY_NAME WRITE_AUDIO
set_parameter_property WRITE_AUDIO WIDTH 4
set_parameter_property WRITE_AUDIO TYPE STD_LOGIC_VECTOR
set_parameter_property WRITE_AUDIO UNITS None
set_parameter_property WRITE_AUDIO ALLOWED_RANGES 0:15
set_parameter_property WRITE_AUDIO HDL_PARAMETER true
add_parameter UPDATE_SAMPLE STD_LOGIC_VECTOR 2
set_parameter_property UPDATE_SAMPLE DEFAULT_VALUE 2
set_parameter_property UPDATE_SAMPLE DISPLAY_NAME UPDATE_SAMPLE
set_parameter_property UPDATE_SAMPLE WIDTH 4
set_parameter_property UPDATE_SAMPLE TYPE STD_LOGIC_VECTOR
set_parameter_property UPDATE_SAMPLE UNITS None
set_parameter_property UPDATE_SAMPLE ALLOWED_RANGES 0:15
set_parameter_property UPDATE_SAMPLE HDL_PARAMETER true
...
set_interface_property SDRAM_avalon_master maximumPendingReadTransactions 0
...
add_interface_port SDRAM_avalon_master sdram_waitrequest waitrequest_n Input 1
